...
- **🛒 Shopping Cart**: Complete cart system with order placement via WhatsApp.
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/your-username/alhor-parfum.git
   cd alhor-parfum
   ```
...
├── lib/              # Utility functions, translations, and shared data
