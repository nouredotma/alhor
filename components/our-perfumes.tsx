    ...
    <section className="w-full pb-16 pt-8" style={{ backgroundColor: 'var(--neutral-50)' }}>
      <div className="max-w-full mx-auto px-4 md:px-12">
        <div className="flex items-center justify-between mb-8">
          ...
          <Link href="/perfumes" className="bg-primary hover:bg-[#CC9F00] text-primary-foreground transition-all px-4 py-2.5 rounded-full text-xs md:text-sm font-medium font-fauna">
