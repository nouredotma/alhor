...
const testimonials = [
  {
    ...
    text: "Alhor Parfum est devenu ma destination préférée pour les huiles parfumées. Leurs senteurs sont authentiques et durent incroyablement longtemps.",
    rating: 5,
  ...
  },
  {
    ...
    text: "Je recommande vivement l'Oud de chez Alhor Parfum. La qualité est exceptionnelle et le service client est aux petits soins.",
    rating: 5,
  ...
  },
  {
    ...
    text: "Une expérience olfactive unique. Les mélanges orientaux qu'ils proposent sont d'une finesse rare. Parfait pour des cadeaux de prestige.",
    rating: 5,
    image: "/profile-man.jpg",
  },
  {
    ...
    text: "Service rapide et emballage luxueux. Alhor Parfum est sans aucun doute le meilleur choix pour les parfums orientaux au Maroc.",
    rating: 5,
  ...
  },
  {
    ...
    text: "Professionnalisme et passion. Chaque parfum que j'ai acheté chez Alhor raconte une histoire. Une adresse incontournable.",
    rating: 5,
    image: "/profile-man.jpg",
  },
  {
    ...
    text: "Une équipe très accueillante qui sait conseiller selon vos goûts. L'encens et le musc sont tout simplement divins.",
    rating: 5,
    image: "/profile-woman-2.jpg",
  },
]
